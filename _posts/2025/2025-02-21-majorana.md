...
Quantum Algorithms. Example: <u>Shor's algorithm</u> - <u>factorisation of large number</u> (used for encryption). Scale of log(N) ($2^{N/2}$ for classic computer), Quantum complexity theory.
