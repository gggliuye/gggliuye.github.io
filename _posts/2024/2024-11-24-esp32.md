...
* CAN transceiver module :
  ...
  * **Configuation tips** : (1) Check the Crystal frequency - **8MHz** - use `MCP_8MHZ` in [https://github.com/coryjfowler/MCP_CAN_lib](https://github.com/coryjfowler/MCP_CAN_lib); (2) Put a **jumper link** on J1 in order to enable the 120 OHM termination resistor ( This is necessary for reducing the reflections on the CAN lines ).
